...
#ifndef FLIR_SPINNAKER_ROS2__IMAGE_H_
#define FLIR_SPINNAKER_ROS2__IMAGE_H_

#include <flir_spinnaker_ros2/pixel_format.h>
...
public:
  Image(
    ...
    int64_t imgT, size_t imageSize, int status, const void * data, size_t w,
...
#endif  // FLIR_SPINNAKER_ROS2__IMAGE_H_
